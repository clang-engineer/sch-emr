...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sql.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SQL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SQL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SQL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SQL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SQL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SQL actions', async () => {
      const expectedActions = [
        {
