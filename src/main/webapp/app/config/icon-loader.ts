...
import { faCircleXmark as faCircleXmarkDuotone } from '@fortawesome/pro-duotone-svg-icons/faCircleXmark';
import { faSquareCaretDown as faSquareCaretDownDuotone } from '@fortawesome/pro-duotone-svg-icons/faSquareCaretDown';
import { faSquareCaretUp as faSquareCaretUpDuotone } from '@fortawesome/pro-duotone-svg-icons/faSquareCaretUp';
...
export const loadIcons = () => {
  library.add(
    ...
    faCircleXmarkDuotone as any,
    faSquareCaretDownDuotone as any,
    faSquareCaretUpDuotone as any
  );
};
