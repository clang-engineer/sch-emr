package com.planitsquare.schemr.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.planitsquare.schemr.repository..*)" +
            " || within(com.planitsquare.schemr.service..*)" +
            " || within(com.planitsquare.schemr.web.rest..*)"
    )
