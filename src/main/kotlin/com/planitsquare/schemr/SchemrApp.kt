...
import com.planitsquare.schemr.config.ApplicationProperties
import com.planitsquare.schemr.config.CRLFLogConverter
...
class SchemrApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<SchemrApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(SchemrApp::class.java)
