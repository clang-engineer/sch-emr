...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.planitsquare.schemr.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.planitsquare.schemr.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.planitsquare.schemr.domain.User::class.java.name)
            createCache(cm, com.planitsquare.schemr.domain.Authority::class.java.name)
            createCache(cm, com.planitsquare.schemr.domain.User::class.java.name + ".authorities")
            createCache(cm, com.planitsquare.schemr.domain.PersistentToken::class.java.name)
            createCache(cm, com.planitsquare.schemr.domain.User::class.java.name + ".persistentTokens")
